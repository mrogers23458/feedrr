...
export default function Home() {
  return (
    <div class="text-center bg-gray-50 text-gray-800 pt-24 px-6">
      <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">The best where should I eat app on the market <br /><span class="text-blue-600">find your yum!</span></h1>
